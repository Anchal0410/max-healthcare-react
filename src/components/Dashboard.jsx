...
// import dashImg from "../assets/dashboard-img1.png";
...
//   //                   title="Pulmonology"
//   //                 />
//   //                 <button className="bg-[#36aaa4] hover:bg-teal-700 text-white px-6 py-2.5 rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap cursor-pointer">
...
//   //           {/* Dashboard Image */}
//   //           <div>
//   //             <div className=" bg-[#34b6b5] rounded-lg -my-20">
//   //               <img
//   //                 src={dashImg}
//   //                 alt="Dashboard"
...
//             <img src={logo} alt="max-logo" className="w-32 sm:w-40 md:w-60" />
...
//               <button className="bg-[#00437B] text-white px-3 lg:px-4 py-2 rounded text-sm font-semibold hover:bg-blue-900 transition-colors whitespace-nowrap">
//                 Book an Appointment
//               </button>
//             </nav>
//           </div>
...
//         {/* Mobile Menu */}
//         {isMobileMenuOpen && (
//           <div className="md:hidden absolute top-16 sm:top-18 md:top-20 left-0 right-0 bg-white border-b z-50">
//             <div className="px-4 py-2 space-y-4">
//               <NavItem text="Hospitals" />
//               <NavItem text="Treatments" />
//               <NavItem text="Services" />
...
//       {/* Specialties Section */}
//       <div className="pt-8 px-4 sm:px-6 md:px-16">
//         {/* Emergency text */}
//         <div
//           className="hidden md:block fixed left-0 top-1/3 bg-[#E31837] text-white px-1 py-20 font-bold
//                       [writing-mode:vertical-lr] rotate-180 tracking-wider text-sm z-10"
...
//                     title="Pulmonology"
//                   />
//                   <button className="bg-[#36aaa4] hover:bg-teal-700 text-white px-4 sm:px-6 py-2.5 rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap w-full sm:w-auto">
//                     <span className="font-medium">Find a Doctor</span>
//                     <ArrowRight className="w-5 h-5" />
//                   </button>
//                 </div>
...
//             {/* Dashboard Image */}
//             <div className="w-full md:w-1/2">
//               <div className="bg-[#34b6b5] rounded-lg -mt-10 sm:-mt-16 md:-mt-20">
//                 <img
//                   src={dashImg}
//                   alt="Dashboard"
...
const NavItem = ({ text }) => (
  <div className="relative group">
    <button className="flex items-center text-[#00437B] hover:text-[#475866] text-sm font-semibold transition-colors">
      {text}
      <ChevronDown className="w-4 h-4 ml-1 opacity-70" />
    </button>
  </div>
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <header className="bg-white border-b sticky top-0 z-50">
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden absolute w-full bg-white border-b shadow-lg transition-all duration-300 ${
      ...
      {/* Main Content */}
      <main className="relative pt-8 px-4 sm:px-6 lg:px-16">
        {/* Emergency text */}
        <div
          className="hidden md:block fixed left-0 top-1/3 bg-[#E31837] text-white px-1 py-20 font-bold 
                    [writing-mode:vertical-lr] rotate-180 tracking-wider text-sm z-10"
        ...
        {/* Mobile Emergency Button */}
        <button className="md:hidden fixed left-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#E31837] text-white px-3 py-2 rounded-lg font-bold shadow-md">
          EMERGENCY
        </button>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <hr className="w-full md:w-1/2 mt-1" />

          <div className="flex flex-col md:flex-row mt-8 gap-8 lg:gap-12">
            {/* Specialties section */}
            <div className="w-full md:w-1/2">
              <h2 className="text-[#40BFB4] text-lg md:text-xl font-medium mb-6 border-b-2 border-[#40BFB4] w-32 py-1">
                Specialities
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-2">
                    <button className="w-full sm:w-auto bg-[#36aaa4] hover:bg-teal-700 text-white px-6 py-2.5 rounded-lg transition-colors flex items-center justify-center sm:justify-start gap-2">
            ...
            <div className="w-full md:w-1/2">
              <div className=" rounded-lg overflow-hidden">
                <div className="relative pt-[75%] bg-[#34b6b5]">
                  <img
                    src={dashImg}
                    alt="Dashboard"
